...
var elem = form.elements.mac; // можно form.elements[0]
const formFild = document.getElementById('form');

  
formFild.addEventListener('keyup', addColon);

function addColon(event){
    const target = event.target;
    target.value = removeCc(target.value);
}
